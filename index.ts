...
const text8 = "Ship to: 221B Baker Street, Apt. 4C, 1600 Pennsylvania Ave NW.";
const text9 = "Visit https://blog.example.com/article or http://sub.domain.org/page";
const text10 = "@_cool_user-21, @Admin1, @Bad@Name, @no space, @toolongusername_exceedslimit";
...
const solution8 = /(\w+[-\.]?\s)+(\w+\.?)/g;
const solution9 = /(?<=http(s?)\:\/\/)\w+(\.\w+)+/g;
const solution10 = /@(\-\_)?\w+(\-?\_?\w+){3,15}/g;
...
console.log(text5.match(solution5));